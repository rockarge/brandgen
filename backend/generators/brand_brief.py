...
{{
  ...
  "highlight_labels": ["Instagram highlight kapağı etiketi 1 — BU MARKAYA ve SEKTÖRÜNE özgü, tek kelime veya çok kısa (max 10 karakter), Türkçe, BÜYÜK HARF. Jenerik 'HAKKINDA/İLETİŞİM' değil — markanın gerçek içerik kategorileri (örn. hukuk bürosu: DAVALAR, kahveci: ÇEKİRDEK, oyun parkı: DOĞUM GÜNÜ)", "etiket 2", "etiket 3", "etiket 4"],
