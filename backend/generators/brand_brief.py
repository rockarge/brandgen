...
{{
  ...
  "brand_name_upper": "Marka adının BÜYÜK HARFLİ hali — logolarda, kartvizitte, banner'larda AYNEN bu basılacak. ⚠️ DİL KURALI: Türkçe kelimelerde i→İ (Pepito→PEPİTO, Meridyen→MERİDYEN, Sigorta→SİGORTA, Demir→DEMİR). YABANCI kelimelerde i→I (Axis→AXIS, Logistics→LOGISTICS, Studio→STUDIO, Digital→DIGITAL, Print→PRINT, Design→DESIGN). Karma isimlerde her kelimeyi AYRI değerlendir: 'Axis Lojistik'→'AXIS LOJİSTİK'. Diğer Türkçe harfler her durumda korunur: ı→I, ş→Ş, ğ→Ğ, ç→Ç, ö→Ö, ü→Ü.",
  "mark_family": "İşaretin hangi HARF-TÜREVLİ AİLEDEN olacağı — SADECE numara (1-5) yaz, açıklama yazma. Aileyi MARKANIN KARAKTERİNE göre seç, rastgele değil: 1=Monogram/ligatür (iki kelimeli isimlerde baş harfler tek forma bağlanır — kurumsal, hukuk, finans, inşaat gibi köklü sektörlere yakışır). 2=Tek harf soyutlaması (harf parçalara indirgenir, kesilir, eğilir, uzatılır — mimarlık, danışmanlık, teknoloji, editoryal markalara yakışır). 3=Negatif alan hikayesi (harfin veya formun içindeki BOŞLUK anlam taşır; konsept cümlesi burada saklanır — fikirli, akıllı, meraklı markalara yakışır). 4=Harf-nesne melezi (harfin bir parçası sektörün nesnesine dönüşür: ok, yaprak, dalga, alev, çatı — lojistik, gıda, enerji, spor gibi somut işlere yakışır). 5=Harf + çevreleyen form (harf kendi çerçevesinin içinde durur; çerçeve DAİRE OLMAK ZORUNDA DEĞİL, markaya göre kalkan/rozet/kemer/yastık/etiket olabilir — zanaat, perakende, kahve, çocuk, kurumsal güven markalarına yakışır). Tek kelimelik kısa isimlerde 1'i SEÇME (tek harf çifti zorlama olur), 2/3/5'ten seç. ⚠️ ÖNYARGI UYARISI: 3 (negatif alan) kulağa en 'akıllı' aile geldiği için otomatik olarak ona kaymak KOLAY BİR TUZAKTIR — bu yüzden 3'ü SADECE markanın konsept cümlesi gerçekten bir BOŞLUKLA anlatılabiliyorsa seç (bir şeyin yokluğu, eksikliği, gizlisi, açığa çıkması). Marka somut bir NESNEYLE anlatılıyorsa 4, formun kendisiyle anlatılıyorsa 2, kimlik/aidiyet/mühür hissi varsa 5, iki kelimelik köklü kurumsal isimse 1 seç. Seçtiğin aileyi kendine şu soruyla test et: 'bu markayı anlatan tek görsel hamle gerçekten bu mu, yoksa alışkanlıktan mı seçtim?' ⚠️ KARARSIZLIK KURALI (20 Tem): 3 ile başka bir aile arasında GERÇEKTEN kararsızsan (ikisi de mantıklı geliyorsa), 3'ü DEĞİL diğerini seç — 3 zaten varsayılan çekim merkezi, eşit ihtimalde ondan UZAKLAŞ.",
  "mark_link": "SADECE mark_family=1 ise doldur, değilse boş string. İki harfin nasıl bağlandığı — sadece şu üç değerden biri: 'interlocked' (harfler iç içe geçer, kesiştikleri yerde çizgi kırılıp over-under örgü oluşur — yaratıcı, dinamik markalar), 'shared' (iki harf ortak bir stroke paylaşır, tek sürekli form gibi okunur — zarif, akıcı markalar), 'adjacent' (harfler ayrı durur, sadece hafifçe temas eder veya hizalanır — ciddi, kurumsal, okunaklılık öncelikli markalar). Marka karakterine göre seç, hep aynısını yazma.",
  ...
  "highlight_labels": ["Instagram highlight kapağı etiketi 1 — BU MARKAYA ve SEKTÖRÜNE özgü, TEK KELİME, max 10 karakter, Türkçe BÜYÜK HARF. KRİTİK: Türkçe büyük harfte i→İ yazılır (MEVSİM, İLETİŞİM — 'MEVSIM' YANLIŞ). Jenerik 'HAKKINDA/İLETİŞİM' değil — markanın gerçek içerik kategorileri (örn. hukuk bürosu: DAVALAR, fırın: MAYA, oyun parkı: OYUNLAR)", "etiket 2", "etiket 3", "etiket 4"],
  "not_included": ["Kit'in KAPSAMADIĞI, bu markanın gerçekten ihtiyacı olacak 3 tasarım işi — SEKTÖRE ÖZGÜ. Kural: kit zaten logo sistemi, renk, tipografi, kartvizit, sosyal medya seti ve mobil hero'yu KAPSIYOR, bunları yazma. Fiziksel/mekânsal/kampanya işlerini yaz, en alakalısı SONA gelsin (liste yukarıdan aşağı okunur, son madde en akılda kalan olur). Örnek — kutu/abonelik markası: 'Kampanya ve reklam üretimi', 'Web sitesi ve arayüz tasarımı', 'Kutu ve ambalaj tasarımı'; hukuk bürosu: 'Tabela ve ofis uygulaması', 'Kampanya ve reklam üretimi', 'Antetli evrak ve dosya sistemi'; kafe: 'Web sitesi ve arayüz tasarımı', 'Tabela ve mekân uygulaması', 'Menü ve ambalaj tasarımı'. Her madde 2-5 kelime, cümle değil.", "iş 2", "iş 3"],
  ...
  "fal_app1_prompt": "Flux için İngilizce prompt — app1 slot (editorial sosyal medya görseli, metin/logo YOK). Kurallar: (1) SADECE İngilizce yaz — Türkçe kelime/cümle KESİNLİKLE karıştırma, (2) visual_language ve mood_words'teki fikri İngilizceye çevirerek somutlaştır (Türkçe kelimeleri olduğu gibi gömme), (3) her rengi 'color name (#hex)' formatında yaz — sadece çıplak hex kod yazma, Flux hex'i büyük ölçüde okumaz, (4) enerji cinematic ise 'cinematic, dramatic, premium, atmospheric photography' tonunda, playful ise 'vivid flat illustration, joyful' tonunda yaz, (5) 'NO text. NO logo. NO watermark.' ile bitir. Max 3 cümle. Örnek: 'Editorial visual for VOLT electric scooter brand. Cinematic urban night scene, motion blur streaks suggesting speed. Electric yellow (#F0C832) accent light against dark slate (#1A1E2E) shadows. NO text. NO logo. NO watermark.'",
  "fal_app2_prompt": "Flux için İngilizce prompt — app2 slot (soyut/kavramsal ikinci görsel, app1'den farklı açı, metin/logo YOK). Kurallar: fal_app1_prompt ile aynı kurallar (sadece İngilizce, isim+hex renk, NO text/logo/watermark) ama farklı bir kompozisyon: sektöre özgü soyut form/doku/desen — playful enerjide markaya özgü somut bir sahne (visual_language'ten türet, jenerik 'confetti/art supplies' gibi klişe kullanma), cinematic enerjide minimal mimari/dokusal kompozisyon. Max 3 cümle.",
  "fal_hero_prompt": "Flux için İngilizce prompt — mobil hero slot (9:16 dikey, uygulama/web açılış görseli, metin/logo YOK). Kurallar: fal_app1_prompt ile aynı kurallar; markanın DÜNYASINI gösteren tek güçlü sahne (mekan, doku, an) — app1/app2'den farklı bir kompozisyon. Max 3 cümle."
}}"""
